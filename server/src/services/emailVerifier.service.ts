...
export function verifyEmail(emailRaw: string): VerificationResult {
...
export function verifyBatchEmails(emails: string[]): {
  results: VerificationResult[];
  summary: { total: number; validCount: number; riskyCount: number; invalidCount: number };
} {
